...
namespace CkeckIn.Migrations
{
    ...
    [Migration("20161211002808_AddedActiveTest")]
    partial class AddedActiveTest
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("CkeckIn.Models.ApplicationUser", b =>
                {
                    b.HasOne("CkeckIn.Models.Questions.Student.Test.StudentTestEntity", "ActiveTestEntity")
                        .WithMany()
                        .HasForeignKey("ActiveTestId");
                });
